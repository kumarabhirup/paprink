          ...
          <div className="home_slider_container">
            <div className="owl-carousel owl-theme home_slider">
              <div className="owl-item">
                <div className="home_slider_background" style={{ backgroundColor: "black", backgroundImage: "url(/static/prebuilt/images/home_slider.jpg)" }}></div>
                <div className="home_slider_content_container">
                  <div className="container">
                    <div className="row">
                      <div className="col">
                        <div className="home_slider_content">
                          <div className="home_slider_item_category trans_200"><a href="#" className="trans_200">sport</a></div>
                          ...
                          <div className="home_slider_item_link">
                            <a href="#" className="trans_200">Continue Reading
                ...
                <div className="similar_posts_container">
                  ...
                  <div className="home_slider_next_container">
                    <div className="home_slider_next" style={{ backgroundImage: "url(/static/prebuilt/images/home_slider_next.jpg)" }}>
